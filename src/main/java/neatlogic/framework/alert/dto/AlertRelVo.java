...
public class AlertRelVo implements Serializable {
    private Long fromAlertId;
    private Long toAlertId;
    ...
    public Long getToAlertId() {
        return toAlertId;
    }

    public void setToAlertId(Long toAlertId) {
        this.toAlertId = toAlertId;
    }
}
